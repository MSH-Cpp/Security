...
AES192_IMPL::AES192_IMPL(const ByteArray& key, const AESInterface::Mode mode)
...
ByteArray AES192_IMPL::encryptCBC(const ByteArray& data) {
...
ByteArray AES192_IMPL::decryptCBC(const ByteArray& data) {
...
ByteArray AES192_IMPL::encryptECB(const ByteArray& data) {
    ByteArray plaintext = data;
    size_t paddedLength = plaintext.size() + (AES_BLOCKLEN - (plaintext.size() % AES_BLOCKLEN));
...
ByteArray AES192_IMPL::decryptECB(const ByteArray& data) {
...
ByteArray AES192_IMPL::encryptCTR(const ByteArray& data) {
    ByteArray iv(AES_BLOCKLEN);

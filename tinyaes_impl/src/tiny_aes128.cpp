...
AES128_IMPL::AES128_IMPL(const ByteArray& key, const AESInterface::Mode mode)
...
ByteArray AES128_IMPL::encryptCBC(const ByteArray& data) {
...
ByteArray AES128_IMPL::decryptCBC(const ByteArray& data) {
...
ByteArray AES128_IMPL::encryptECB(const ByteArray& data) {
    ByteArray plaintext = data;
    size_t paddedLength = plaintext.size() + (AES_BLOCKLEN - (plaintext.size() % AES_BLOCKLEN));
...
ByteArray AES128_IMPL::decryptECB(const ByteArray& data) {
...
ByteArray AES128_IMPL::encryptCTR(const ByteArray& data) {
    ByteArray iv(AES_BLOCKLEN);
